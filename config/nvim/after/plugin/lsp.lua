...
local on_attach = function(_, _)
  ...
  vim.keymap.set("n", "grf", function() vim.lsp.buf.references() end)
  vim.keymap.set("n", "gd", function() vim.lsp.buf.definition() end)
  vim.keymap.set("n", "gD", function() vim.lsp.buf.implementation() end)
  vim.keymap.set("n", "dc", function() vim.lsp.buf.hover() end)
  vim.keymap.set("n", "ds", function() vim.lsp.buf.signature_help() end)
  vim.keymap.set("n", "gT", function() vim.lsp.buf.type_definition() end)
  vim.keymap.set("n", "dl", function() vim.diagnostic.open_float() end)
  vim.keymap.set("n", "dn", function() vim.diagnostic.goto_next() end)
  vim.keymap.set("n", "dN", function() vim.diagnostic.goto_prev() end)
  vim.keymap.set("n", "do", function() vim.diagnostic.enable() end)
  vim.keymap.set("n", "df", function() vim.diagnostic.disable() end)
end
